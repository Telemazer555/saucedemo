...
class TestAsync:
    ...
    @pytest.mark.asyncio
    async def test_parallel_all1(self, item_async_factory):
    ...
    @pytest.mark.asyncio
    async def test_parallel_all2(self, item_async_factory):
        items = [await item_async_factory() for _ in range(8)]
